...
output "c_simplemapvariable_flattened_2" {
  value = {
...
```console
c_simplemapvariable_flattened_2 = {
  "CRM" = {
    "AppName" = "CRM Application"
    "Description" = "This is the CRM Application"
    "Environment" = "prod"
...
resource "null_resource" "listobject"{
  for_each =     {
...
output "c_simplemapvariable_flattened_3" {
  value = null_resource.listobject
}

```

```output
c_simplemapvariable_flattened_3 = {
  "CRM" = {
